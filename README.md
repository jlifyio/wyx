...
[![Version](https://img.shields.io/badge/version-0.15.0-blue)](https://github.com/jlifyio/wyx/releases/tag/v0.15.0) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE) [![Claude Code Plugin](https://img.shields.io/badge/Claude_Code-Plugin-orange)](https://claude.com/claude-code)
...
```mermaid
graph LR
    A["You write CONCEPT.md\n## interactions\n- NEVER access Orders repository"] -->|"wyx hook fires\non every write"| B["Claude sees boundaries\nbefore writing code"]
    B --> C["Claude uses getOrderTotal()\nvia service API ✅"]
    B -.->|"without wyx"| D["Claude imports findOrder()\nfrom orders/repository ❌"]
